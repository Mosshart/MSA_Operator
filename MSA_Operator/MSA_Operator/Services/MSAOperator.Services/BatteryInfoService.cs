...
//    public class BatteryInfoBase : INotifyPropertyChanged
//    {
//        #region private 
...
//        public BatteryInfoBase(IBatteryInfoService service)
//        {
...
//    public struct TabletBatteryInfoData : IBatteryInfoData
//    {
...
//    public class RobotBatteryInfoService : BatteryInfoBase
//    {
//        public RobotBatteryInfoService(IBatteryInfoService service) : base(service)
//        {
//        }
//    }
...
//        {
//            return new TabletBatteryInfoData
//            {
...
//    //public class BatteryInfoService : /*IBatteryInfo,*/ INotifyPropertyChanged
//    //{
...
//    //        _timer.Tick += (sender, args) =>
//    //        {
//    //            BatteryInfoData data = BatteryInfo.GetBatteryInformation();
//    //            PercentCap =  getPercentLevel(data.CurrentCapacity, data.FullChargeCapacity); //PercentCap - 1;//
//    //        };
//    //        _timer.Start();
//    //    }
...
//    //    private DispatcherTimer _timer;
//    //    #region private
//    //    /*   public struct BatteryInformationData
//    //       {
//    //           uint _currentCapacit;
//    //           int _designedMaxCapacity;
//    //           int _fullChargeCapacity;
//    //           uint _voltage;
//    //           int _dischargeRate;
//    //       }*/
//    //       private uint _currentCapacit;
//    //       private int _designedMaxCapacity;
//    //       private int _fullChargeCapacity;
//    //       private uint _voltage;
//    //       private int _dischargeRate;
//    //       private int _percentCap;
//    //       public string _batteryPercentText;

//    //       #endregion
//    //       #region public 
//    //       public uint CurrentCapacity { 
//    //           get => _currentCapacit;
//    //           set { _currentCapacit = value; }
//    //       }
//    //       public int DesignedMaxCapacity { 
//    //           get => _designedMaxCapacity;
//    //           set { _designedMaxCapacity = value; OnPropertyChanged(); }
//    //       }
//    //       public int FullChargeCapacity { 
//    //           get => _fullChargeCapacity;
//    //           set { _fullChargeCapacity = value; OnPropertyChanged(); }
//    //       }
//    //       public uint Voltage {
//    //           get => _voltage;
...
//    //           get => _dischargeRate;
//    //           set { _dischargeRate = value; OnPropertyChanged(); }
//    //       }
//    //       public int PercentCap
//    //       {
//    //           get => _percentCap;
...
//    //    private int getPercentLevel(uint value, int maxValue)
//    //    {
//    //        return (int)Math.Round((float)(Convert.ToInt32(value) * 100) / maxValue);
//    //    }
